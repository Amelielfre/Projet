...
final class Version20220404140050 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE archives_sorties (
...
pseudo_organisateur VARCHAR(255) NOT NULL, 
nom_organisateur VARCHAR(255) NOT NULL, 
prenom_organisateur VARCHAR(255) NOT NULL, 
cp_ville VARCHAR(5) NOT NULL, 
nom_ville VARCHAR(255) NOT NULL, PRIMARY KEY(id)) 
